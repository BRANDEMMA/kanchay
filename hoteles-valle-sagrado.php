...
?>
		<div class="ajustar-hoteles">
			<div class="contenedor-hotel espacio-opciones">
				<div class="img-hotel">
					<img id="grande-hotel-b1-1" src="img/hoteles/aranwa-sacred-vallet/aranwa-sacred-vallet-1.1.jpg">
					<img id="grande-hotel-b1-2" style="display:none;" src="img/hoteles/aranwa-sacred-vallet/aranwa-sacred-vallet-1.2.jpg">
					<img id="grande-hotel-b1-3" style="display:none;" src="img/hoteles/aranwa-sacred-vallet/aranwa-sacred-vallet-1.3.jpg">
					<a href="aranwa-sacred-valley.php">Ver más</a>
				</div>
				<div class="miniaturas-hotel">
					<img id="mini-hotel-b1-1" src="img/hoteles/aranwa-sacred-vallet/aranwa-sacred-vallet-2.1.jpg">
					<img id="mini-hotel-b1-2" src="img/hoteles/aranwa-sacred-vallet/aranwa-sacred-vallet-2.2.jpg">
					<img id="mini-hotel-b1-3" src="img/hoteles/aranwa-sacred-vallet/aranwa-sacred-vallet-2.3.jpg">
				</div>	
				<div class="detalle-hotel">
					<h5><a href="aranwa-sacred-valley.php">Aranwa Sacred Valley</a></h5>
					<p>Se encuentra en una lujosa hacienda del siglo XVII situada en el camino a Machu Pichu.<br>

					El centro de bienestar ofrece una gama completa...</p>
				</div>
				<div class="clear"></div>
			</div>
