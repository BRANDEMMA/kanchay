...
?>
			<div class="contenedor-hotel espacio-opciones">
				...
				<div class="detalle-hotel">
					...
					<p>Ubicado junto al Océano Pacífico, este hotel de lujo goza de vistas espectaculares hacia el mar.<br><br>

					Combina un servicio personalizado, restaurantes excepcionales e instalaciones de lujo.<br><br> 
			...
			<div class="contenedor-hotel">
				...
				<div class="detalle-hotel">
					...
					<p>Ubicado en el prestigioso distrito de San Isidro en Lima y rodeado de elegantes embajadas. <br><br>

					Personifica la sofisticación y uno de los pocos hoteles reconocidos como Patrimonio Cultural del Perú.<br><br> 
			...
			<div class="contenedor-hotel espacio-opciones">
				...
				<div class="detalle-hotel">
					...
					<p>Disfrute de unas maravillosas vistas al mar desde nuestro hotel en Miraflores.<br><br>

					Situado frente a los imponentes acantilados del distrito de Miraflores<br><br> 
			...
			<div class="contenedor-hotel">
				...
				<div class="detalle-hotel">
					...
					<p>Situado en el vibrante distrito financiero y de compras de Lima.<br><br>

					Saboree la innovadora cocina peruana a manos del chef Rafael en Maras<br><br> 
