	...
	<div class="fondo-azulclaro">
		...
		<div class="hoteles-descripcion">
			...
			<div class="izquierda-descripcion">
				<img id="grande-hotel-1a" src="img/hoteles/jose-antonio/jose-antonio-1.1.jpg">
				<img id="grande-hotel-2a" style="display:none;" src="img/hoteles/jose-antonio/jose-antonio-1.2.jpg">
				<img id="grande-hotel-3a" style="display:none;" src="img/hoteles/jose-antonio/jose-antonio-1.3.jpg"> 

				<img id="mini-hotel-1a" class="img-mini" src="img/hoteles/jose-antonio/jose-antonio-2.1.jpg">
				<img id="mini-hotel-2a" class="img-mini" src="img/hoteles/jose-antonio/jose-antonio-2.2.jpg">
				<img id="mini-hotel-3a" class="img-mini" src="img/hoteles/jose-antonio/jose-antonio-2.3.jpg">
			</div>
