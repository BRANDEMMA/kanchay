	...
	<div class="fondo-azulclaro">
		...
		<div class="hoteles-descripcion">
			...
			<div class="izquierda-descripcion">
				<img id="grande-hotel-1a" src="img/hoteles/costa-del-sol-ramada-cuzco/costa-del-sol-ramada-cuzco-1.1.jpg">
				<img id="grande-hotel-2a" style="display:none;" src="img/hoteles/costa-del-sol-ramada-cuzco/costa-del-sol-ramada-cuzco-1.2.jpg">
				<img id="grande-hotel-3a" style="display:none;" src="img/hoteles/costa-del-sol-ramada-cuzco/costa-del-sol-ramada-cuzco-1.3.jpg"> 

				<img id="mini-hotel-1a" class="img-mini" src="img/hoteles/costa-del-sol-ramada-cuzco/costa-del-sol-ramada-cuzco-2.1.jpg">
				<img id="mini-hotel-2a" class="img-mini" src="img/hoteles/costa-del-sol-ramada-cuzco/costa-del-sol-ramada-cuzco-2.2.jpg">
				<img id="mini-hotel-3a" class="img-mini" src="img/hoteles/costa-del-sol-ramada-cuzco/costa-del-sol-ramada-cuzco-2.3.jpg">
			</div>
			<div class="derecha-descripcion">
				<p>
				El Costa del Sol Cusco ocupa una mansión reformada del siglo XVII situada en el centro de Cusco, a poca distancia a pie de la plaza Mayor de la ciudad y de la iglesia de La Merced. Este establecimiento ofrece alojamientos de estilo colonial y proporciona conexión WiFi gratuita. La cadena hotelera Costa del Sol cuenta con hoteles en las 7 ciudades más importantes de Perú.<br><br>
