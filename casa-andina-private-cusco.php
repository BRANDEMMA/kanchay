...
<body>
	...
	<div class="fondo-azulclaro">
		...
		<div class="hoteles-descripcion">
			<h3>CASA ANDINA PRIVATE COLLECTION CUSCO</h3>
			<div class="izquierda-descripcion">
				<img id="grande-hotel-1a" src="img/hoteles/casa-andina-cuzco/casa-andina-cuzco-1.1.jpg">
				<img id="grande-hotel-2a" style="display:none;" src="img/hoteles/casa-andina-cuzco/casa-andina-cuzco-1.2.jpg">
				<img id="grande-hotel-3a" style="display:none;" src="img/hoteles/casa-andina-cuzco/casa-andina-cuzco-1.3.jpg"> 

				<img id="mini-hotel-1a" class="img-mini" src="img/hoteles/casa-andina-cuzco/casa-andina-cuzco-2.1.jpg">
				<img id="mini-hotel-2a" class="img-mini" src="img/hoteles/casa-andina-cuzco/casa-andina-cuzco-2.2.jpg">
				<img id="mini-hotel-3a" class="img-mini" src="img/hoteles/casa-andina-cuzco/casa-andina-cuzco-2.3.jpg">
			</div>
